    ...
    return (
        <div className="min-h-screen p-8 sm:p-20 flex flex-col items-center justify-center">
            <div className="fixed top-0 left-0 p-4 z-10">
                <Link href="/server-display" className="text-blue-500 hover:text-blue-700 underline">Go To Server Side Rendered Display</Link>
            </div>
            <h1 className="text-2xl font-bold mb-8 text-center">Client Side Rendered Page Data Display</h1>
